  ...
  const [photos] = useState([
    {
      ...
      picture: 'NoshUp',
      description:
        "Finding a buddy to have meal togther? This is the place for you. Schedule an event specifying the cuisine and how many fellows you want to eat with or join an exising event. No longer eating alone."
    },
    {
      name: "Walk'n Spot",
    ...
    },
    {
      ...
      description:
        'Look up property for sale and city weather forcast with a simple search. Website built with HTML, CSS and Javascript. '
    },
    {
    ...
    },
    {
      ...
      description:
        'Daily work/task tracker to help you get things done on time. '
    }
  ]);
            ...
            <Card className="bg-dark text-white container">
              ...
              <Card.ImgOverlay className='mask overlay'>
                  <Card.Title className='text-center'>
                    ...
                    <Card.Link href={image.GitHub} target="_blank" rel="noreferrer" className="work">
                    ...
                    <Card.Link href={image.Website} target="_blank" rel="noreferrer" className="work">
